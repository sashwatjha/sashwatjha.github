...
const specializationsItem = document.querySelectorAll("[data-specializations-item]");
...
for (let i = 0; i < specializationsItem.length; i++) {

  specializationsItem[i].addEventListener("click", function () {

    modalImg.src = this.querySelector("[data-specializations-avatar]").src;
...
modalCloseBtn.addEventListener("click", specializationsModalFunc);
overlay.addEventListener("click", specializationsModalFunc);
